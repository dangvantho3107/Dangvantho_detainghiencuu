...
X_train, y_train = read_data(path_train,1000)
X_test, y_test = read_data(path_test,1000)

print("So luong du lieu trong tap huan luyen: ",len(X_train))
print("So luong du lieu trong tap kiem tra: ",len(X_test))
...
print("So luong cac nhan: ", len(list_label))
...
print("Da tien xu ly du lieu tap train xong!")

print("Bat dau tien xu ly du lieu tap test")
...
print("Da tien xu ly xong du lieu tap test")
...
print("Kich thuoc cua vector sau khi dung TF-IDF: ", X_train_tfidf.shape)


# Khởi tạo mô hình Naive Bayes để huấn luyện mô hình trên tập huấn luyện
print("Bat dau huan luyen mo hinh Naive Bayes")
...
print("Ket qua cac do do Naive Bayes")
...
print("Ket qua chi tiet tung class trong mo hinh Naive Bayes")
